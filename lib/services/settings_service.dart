...
class SettingsService extends ChangeNotifier {
  ...
  static const String _keyNotificationsMedicamentos = 'notifications_medicamentos';
  static const String _keyNotificationsCompromissos = 'notifications_compromissos';
  static const String _keyAccessibilityTtsEnabled = 'accessibility_tts_enabled';
  static const String _keyAccessibilityVibrationEnabled = 'accessibility_vibration_enabled';
  ...
  Future<void> _loadAllSettings() async {
    ...
    _notificationsMedicamentos = _prefs!.getBool(_keyNotificationsMedicamentos) ?? _defaultNotificationsMedicamentos;
    _notificationsCompromissos = _prefs!.getBool(_keyNotificationsCompromissos) ?? _defaultNotificationsCompromissos;
    _accessibilityTtsEnabled = _prefs!.getBool(_keyAccessibilityTtsEnabled) ?? _defaultAccessibilityTtsEnabled;
    _accessibilityVibrationEnabled = _prefs!.getBool(_keyAccessibilityVibrationEnabled) ?? _defaultAccessibilityVibrationEnabled;
    _accessibilityFontScale = _prefs!.getDouble(_keyAccessibilityFontScale) ?? _defaultAccessibilityFontScale;
  ...
  // Getters
  bool get notificationsMedicamentos => _notificationsMedicamentos ?? _defaultNotificationsMedicamentos;
  bool get notificationsCompromissos => _notificationsCompromissos ?? _defaultNotificationsCompromissos;
  bool get accessibilityTtsEnabled => _accessibilityTtsEnabled ?? _defaultAccessibilityTtsEnabled;
  bool get accessibilityVibrationEnabled => _accessibilityVibrationEnabled ?? _defaultAccessibilityVibrationEnabled;
  double get accessibilityFontScale => _accessibilityFontScale ?? _defaultAccessibilityFontScale;
  ...
  Future<bool> setAccessibilityVibrationEnabled(bool value) async {
    ...
    final success = await _prefs!.setBool(_keyAccessibilityVibrationEnabled, value);
    if (success) {
  ...
  Future<bool> setAccessibilityFontScale(double value) async {
    ...
    final success = await _prefs!.setDouble(_keyAccessibilityFontScale, clampedValue);
    if (success) {
  ...
  Future<bool> setAccessibilityVoiceSpeed(double value) async {
    ...
    final success = await _prefs!.setDouble(_keyAccessibilityVoiceSpeed, clampedValue);
    if (success) {
  ...
  Future<void> resetToDefaults() async {
    ...
    await setAccessibilityVibrationEnabled(_defaultAccessibilityVibrationEnabled);
