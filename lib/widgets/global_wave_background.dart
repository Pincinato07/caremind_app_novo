...
class GlobalWaveBackground extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // RepaintBoundary isola os repaints do background
    // Isso evita que widgets acima sejam reconstruídos quando as ondas animam
    return RepaintBoundary(
      child: Stack(
        children: [
          // Gradiente de fundo (estático, não precisa de RepaintBoundary)
          Container(
